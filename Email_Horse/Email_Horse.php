 ...
 * 
 * @author Manomite George <manomitehq@gmail.com> 
 * @copyright Copyright (c) 2019, Mitnets Technologies
 * @version 1.0.0
 * @url https://www.mitnets.com
 */ 
class Email_Horse { 
    ...
    public function setEmailFrom($email) { 
        if (!self::validate($email)) { 
            ...
            if ($this->exceptions) { 
                throw new EmailHorseException($this->ErrorInfo); 
            } 
        } 
        $this->from = $email; 
    } 
 ...
 */ 
class EmailHorseException extends Exception { 
